...
def build_experiment_block(
    *,
    ...
    server_args = server_args_map.get(scheduler_anchor, [])
    ...
    if bench_args_mode == "name":
        lines.append(f"    bench_args: [{yaml_scalar(exp_name)}]")
    elif bench_args_mode == "name_2048":
        lines.append(f"    bench_args: [{yaml_scalar(exp_name)}, 2048]")
...
# python '/home/xxf/NewVLLM/vllm/experiment/auto/gen_sglang.py' --metadata /home/xxf/NewVLLM/vllm/experiment/auto/metadata_sglang.yaml --matrix /home/xxf/NewVLLM/vllm/experiment/auto/matrix_sglang.yaml --output /home/xxf/NewVLLM/vllm/experiment/auto/experiment_sglang.yaml