"""Filter a trace CSV, keeping only rows where ContextTokens + GeneratedTokens <= max_len.

Usage:
    python filter_trace.py INPUT.csv OUTPUT.csv [--max-len 2048]
"""
...
def main():
    parser = argparse.ArgumentParser(
        description="Filter trace CSV by total token length")
